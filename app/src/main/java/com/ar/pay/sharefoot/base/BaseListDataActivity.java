...
public abstract class BaseListDataActivity<M> extends AppCompatActivity implements OnResult<M>,SwipeRefreshLayout.OnRefreshListener{
    ...
    protected abstract void onUICreate(Bundle savedInstanceState);
    ...
    private void onConfig() {
        ...
        if(recycler!=null){
            ...
            //添加分割线
            SpaceDecoration itemDecoration = new SpaceDecoration((int) Utils.convertDpToPixel(4,this));
